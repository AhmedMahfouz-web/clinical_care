<nav class="navbar custom-navbar navbar-expand-lg py-2">
    <div class="container-fluid px-0">
        ...
        <a href="index.html" class="navbar-brand"><img src="{{ asset('images/brand/icon.svg') }}" alt="BigBucket" />
                    ...
                    <div class="dropdown-menu dropdown-menu-left dropdown-menu-xl py-0">
                        <div class="py-3 px-3">
                            <h5 class="heading h6 mb-0">Notifications <span
                                    class="badge badge-pill badge-primary text-uppercase float-left">3</span></h5>
                        </div>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-left">
                        ...
                        <a class="dropdown-item" href="javascript:void(0);"><span
                                class="float-left badge badge-success">$50K</span><i
                                class="fa fa-briefcase text-primary"></i>My Balance</a>
                        <a class="dropdown-item" href="javascript:void(0);"><span
                                class="float-left badge badge-warning">4</span><i
                        ...
                        <form action="{{ route('adminLogout') }}" method="post">
                            @csrf
                            <button class="dropdown-item"><i class="fa fa-sign-out text-primary"></i>Sign out</button>
                        </form>
                    </div>
                </li>
            </ul>
